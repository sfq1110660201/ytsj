 <template>
  <div class="addfinished_page">
        <head-top head-title="关心" go-back='true'></head-top>
        <ul class="headNav">
    	...
    	<section  v-if="" class="contentContainer">
    		<mt-loadmore :top-method="loadTop" @top-status-change="handleTopChange" :bottom-method="loadBottom" :bottom-all-loaded="allLoaded" :auto-fill='bool' ref="loadmore">
				<router-link to="/paragraph" class="shop_li"  tag='li' v-for="labelList in labelLists" >
					...
					<section v-if="">
						<img src="../../../static/img/cbd.jpg" class="shop_img" style="">
					</section>
				</router-link>
