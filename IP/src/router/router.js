...
//修改密码
const testPassword = r => require.ensure([], () => r(require('../page/ipManage/children/children/changePassword/testPassword')), 'testPassword')
const completePassword = r => require.ensure([], () => r(require('../page/ipManage/children/children/changePassword/completePassword')), 'completePassword')
const changeAnotherPassword = r => require.ensure([], () => r(require('../page/ipManage/children/children/changePassword/changeAnotherPassword')), 'changeAnotherPassword')
//登陆
            	...
            	children:[{
            		...
            		component:userData,
              		...
              		children: [{//,,
		                ...
		                path: 'changeAnotherPassword', 
		                component: changeAnotherPassword,
		            }, {
