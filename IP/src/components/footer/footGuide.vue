...
<style lang="scss" scoped>
   ...
   .knowledgeDark{background: url(../../../static/img/btn_nav_ZhiShi@2x.png);background-size: cover;}
   .knowledgeLight{background: url(../../../static/img/btn_hig_ZhiShi@2x.png);background-size: cover;}
   .careDark{background: url(../../../static/img/btn_nav_GuanXin@2x.png);background-size: cover;}
   .careLight{background: url(../../../static/img/btn_hig_GuanXin@2x.png);background-size: cover;}
   .meDark{background: url(../../../static/img/btn_nav_GeRen@2x.png);background-size: cover;}
   .meLight{background: url(../../../static/img/btn_hig_GeRen@2x.png);background-size: cover;}
</style>
