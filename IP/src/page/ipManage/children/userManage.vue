<template>
	<div class="yituMiddleContent">
		<div class="modelLeft" :style="{height:het+'px'}">
			<router-link to="" tag='li' class="modelTabs" :class="{activeLi:$route.path.indexOf('myYiTu') !== -1}">粉丝用户</router-link>
			<router-link to="" tag='li' class="modelTabs" :class="{activeLi:$route.path.indexOf('addYiTu') !== -1}">潜在用户</router-link>
		</div>
