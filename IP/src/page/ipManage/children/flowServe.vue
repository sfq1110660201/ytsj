<template>
	<div class="yituMiddleContent">
		<div class="modelLeft" :style="{height:het+'px'}">
			...
			<router-link to=""  tag='li' class="modelTabs" :class="{activeLi:$route.path.indexOf('myYiTu') !== -1}">医生评价</router-link>
			<router-link to="" tag='li' class="modelTabs" :class="{activeLi:$route.path.indexOf('addYiTu') !== -1}">社群管理工具</router-link>
		</div>
