<template>
	<div class="shoplist_container containerRepair">
		<ul class="containerLeft">
			...
			<router-link to="/ETmsite/ETpregnanting/ETdiet" tag='li' class="lebalParts" v-bind:class="{ diet: dietItem2.isNormal, dietShow:dietItem2.isLight }" @click.native="diet2()"></router-link>
			<router-link to="/ETmsite/ETpregnanting/ETNursing" tag='li' class="lebalParts" v-bind:class="{ nursing: nursingItem2.isNormal, nursingShow:nursingItem2.isLight }" @click.native="nursing2()"></router-link>
			<router-link to="/ETmsite/ETpregnanting/ETbaoJian" tag='li' class="lebalParts" v-bind:class="{ healthcare: healthcareItem2.isNormal, healthcareShow:healthcareItem2.isLight }" @click.native="healthcare2()"></router-link>
			<router-link to="/ETmsite/ETpregnanting/ETeducation" tag='li' class="lebalParts" v-bind:class="{ education: educationItem2.isNormal, educationShow:educationItem2.isLight }" @click.native="education2()"></router-link>
		</ul>
...
//		props:['searchValue'],
		methods: {
			...
			goParagraph(pregnanting) { //存储文章id
				this.$router.push({path:"/ETparagraph/"+pregnanting.articleId})
