 <template>
  	<div class="download_page">
        <head-top head-title="我" ></head-top>
    	<section class="logIn">
    		...
    		<div class="serviceArgument ">
            	...
            	<router-link :to="{ path: '/ETagreement'}" style="color: #ff9c9c;">用户服务与隐私协议</router-link>
    		</div>
    	</section>
	...
	　　        },
            ...
            login(){
                ...
                if(phoneText!="" && isChecked==true){
                    ...
                    this.$router.push({path: '/ETlebalChoice'})
                }
            },
			loginAuthorization(){
				var href=window.location.href.split('#')[0];//http://localhost:8088/
				console.log(href)
				location.href=href+"#/ETmeInfoprofile"
