<template>
	<div class="shoplist_container containerRepair">
		<ul class="containerLeft">
			...
			<router-link to="/JKCSmsite/JKCSrecovery/JKCSdiet" tag='li' class="lebalParts" v-bind:class="{ diet: dietItem3.isNormal, dietShow:dietItem3.isLight }" @click.native="diet3()"></router-link>
			<router-link to="/JKCSmsite/JKCSrecovery/JKCSNursing" tag='li' class="lebalParts" v-bind:class="{ nursing: nursingItem3.isNormal, nursingShow:nursingItem3.isLight }" @click.native="nursing3()"></router-link>
			<router-link to="/JKCSmsite/JKCSrecovery/JKCSbaoJian" tag='li' class="lebalParts" v-bind:class="{ healthcare: healthcareItem3.isNormal, healthcareShow:healthcareItem3.isLight }" @click.native="healthcare3()"></router-link>
			<router-link to="/JKCSmsite/JKCSrecovery/JKCSeducation" tag='li' class="lebalParts" v-bind:class="{ education: educationItem3.isNormal, educationShow:educationItem3.isLight }" @click.native="education3()"></router-link>
		</ul>
...
//		props:['searchValue'],
		methods: {
			...
			goParagraph(recovery) { //
				this.$router.push({path:"/JKCSparagraph/"+recovery.articleId})
