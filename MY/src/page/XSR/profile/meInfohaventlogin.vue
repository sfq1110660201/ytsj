 <template>
  	<div class="download_page">
    	...
    	<section class="logIn">
            ...
            <div class="loginContent">
    			<img class="weiChatLogIn" src="/static/MY/img/weichatLogin.png" @click="loginAuthorization()"/>
    		</div>
    		<div class="serviceArgument ">
            	...
            	<router-link :to="{ path: '/XSRagreement'}" style="color: #ff9c9c;">用户服务与隐私协议</router-link>
    		</div>
    	</section>
	...
	　　        },
            ...
            login(){
                ...
                if(phoneText!="" && isChecked==true){
                    ...
                    this.$router.push({path: '/XSRlebalChoice'})
                }
            },
			loginAuthorization(){
				var href=window.location.href.split('#')[0];//http://localhost:8088/
				console.log(href)
				location.href=href+"#/XSRmeInfoprofile"
				//location.href="https://ip.lotusdata.com/wx/app/baby#/meInfoprofile"
