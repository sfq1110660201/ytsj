  ...
  <div class="rating_page">
        ...
        <section class="familyChoice">
            ...
            <section class="labelsContainer">
                <ul>
					<router-link to="/XSRaddCare" class="editPiece" v-for="label in labels"><mt-button class="edit" type="danger">编辑</mt-button><p class="editObj">{{label.labelName}}</p></router-link>
				</ul>
            </section> 
