<template>
	<div class="shoplist_container containerRepair">
		<ul class="containerLeft">
			...
			<router-link to="/XSRmsite/XSRbeforepregnant/XSRdiet" tag='li' class="lebalParts" v-bind:class="{ diet: dietItem.isNormal, dietShow:dietItem.isLight }" @click.native="diet()"></router-link>
			<router-link to="/XSRmsite/XSRbeforepregnant/XSRNursing" tag='li' class="lebalParts" v-bind:class="{ nursing: nursingItem.isNormal, nursingShow:nursingItem.isLight }" @click.native="nursing()"></router-link>
			<router-link to="/XSRmsite/XSRbeforepregnant/XSRbaoJian" tag='li' class="lebalParts" v-bind:class="{ healthcare: healthcareItem.isNormal, healthcareShow:healthcareItem.isLight }" @click.native="healthcare()"></router-link>
			<router-link to="/XSRmsite/XSRbeforepregnant/XSReducation" tag='li' class="lebalParts" v-bind:class="{ education: educationItem.isNormal, educationShow:educationItem.isLight }" @click.native="education()"></router-link>
		</ul>
	...
	export default {
		...
		methods: {
			...
			goParagraph(beforepregnant) { //存储文章id
				this.$router.push({path:"/XSRparagraph/"+beforepregnant.articleId})
