<template>
	<div class="shoplist_container containerRepair">
		<ul class="containerLeft">
			...
			<router-link to="/XSRmsite/XSRpregnanting/XSRdiet" tag='li' class="lebalParts" v-bind:class="{ diet: dietItem2.isNormal, dietShow:dietItem2.isLight }" @click.native="diet2()"></router-link>
			<router-link to="/XSRmsite/XSRpregnanting/XSRNursing" tag='li' class="lebalParts" v-bind:class="{ nursing: nursingItem2.isNormal, nursingShow:nursingItem2.isLight }" @click.native="nursing2()"></router-link>
			<router-link to="/XSRmsite/XSRpregnanting/XSRbaoJian" tag='li' class="lebalParts" v-bind:class="{ healthcare: healthcareItem2.isNormal, healthcareShow:healthcareItem2.isLight }" @click.native="healthcare2()"></router-link>
			<router-link to="/XSRmsite/XSRpregnanting/XSReducation" tag='li' class="lebalParts" v-bind:class="{ education: educationItem2.isNormal, educationShow:educationItem2.isLight }" @click.native="education2()"></router-link>
		</ul>
...
//		props:['searchValue'],
		methods: {
			...
			goParagraph(pregnanting) { //存储文章id
				this.$router.push({path:"/XSRparagraph/"+pregnanting.articleId})
